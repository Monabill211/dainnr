...
export default function Hero() {
  return (
        <div className='flex flex-col justify-between align-center items-center text-center mt-10 bg-gray-100 h-screen' style={{padding:"20px", overflow:"hidden",marginBottom:"100px"}}>
